...
globalkeys = awful.util.table.join(
    ...
    --screen browsing
    awful.key({ modkey,           }, "Left", function () awful.screen.focus( 2) end,
              {description = "left screen active", group = "tag"}),
    awful.key({ modkey,           }, "Right", function () awful.screen.focus( 1) end,
              {description = "right screen active", group = "tag"}),
    ...
    awful.key({ altkey, "Control" }, "m",
        function ()
            os.execute(string.format("amixer -D pulse sset %s 100%%", beautiful.volume.channel))
            beautiful.volume.update()
        end),
    awful.key({ altkey, "Control" }, "0",
        function ()
            os.execute(string.format("amixer -D pulse sset 0%%", beautiful.volume.channel))
            beautiful.volume.update()
        end),

    -- layout 
    awful.key({ "Shift" }, "Alt_L", function() 
            beautiful.kbdcfg:next()
            beautiful.kbdcfg:update() 
            end ),
